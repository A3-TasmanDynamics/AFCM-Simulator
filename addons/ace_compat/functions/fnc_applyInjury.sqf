...
if (typeName _injury != "HASHMAP") exitWith {
    diag_log text format ["[AFCM-Simulator][ACE backend] applyInjury aborted - _injury is %1, not a HashMap (caller bug - see afcm_sim_scenario_fnc_buildInjury).", typeName _injury];
};
