 ...
 * KAT - Advanced Medical backend implementation of the removeInjury interface function.
 *
...
diag_log text format ["[AFCM-Simulator][KAT backend] removeInjury stub called for %1 - not yet implemented, see fnc_removeInjury.sqf TODO.", _unit];
