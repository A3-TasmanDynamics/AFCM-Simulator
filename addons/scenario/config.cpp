...
class CfgFunctions
{
    class afcm_sim_scenario
    {
        ...
        class Presets
        {
            ...
            class exportInjuries { file = "\afcm_sim\addons\scenario\functions\fnc_exportInjuries.sqf"; };
            class readLiveKatExtras { file = "\afcm_sim\addons\scenario\functions\fnc_readLiveKatExtras.sqf"; };
