...
| [ACE_COMPAT.md](docs/ACE_COMPAT.md) | Deep dive on the `afcm_sim_ace_compat` backend — function reference, `LimbId`/`woundType` mapping tables, and why injury application needs two ACE3 calls, not one |
